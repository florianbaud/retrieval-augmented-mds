...
class ModelConfig:
    ...
    query_encoder_path: str = "allenai/longformer-base-4096"
    ...
    memory_model_name: str = "allenai/longformer-base-4096"
    ...
    mips_model_name: str = "allenai/longformer-base-4096"

...
from transformers import BartTokenizer, BartForConditionalGeneration, GenerationConfig, PreTrainedTokenizer
...
class BartModelConfig:
    pretrained_model_name_or_path: str = "facebook/bart-large"
...
class BartLightning(pl.LightningModule):
